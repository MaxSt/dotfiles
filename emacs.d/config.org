...
#+begin_src emacs-lisp
  ...
  (defun is-lisp-mode ()
    "check if mode is a lisp mode"
    (seq-contains lisp-modes major-mode))

  (general-define-key :states '(normal)
                      :predicate '(is-lisp-mode)
                      "c" (general-key-dispatch 'evil-sp-change
                            :name general-dispatch-evil-change-exchange-sp
                            "x" 'evil-exchange
                            "X" 'evil-exchange-cancel))

  (general-define-key "c" (general-key-dispatch 'evil-change
...
#+BEGIN_SRC emacs-lisp
  ...
  (general-define-key :keymaps '(cider-popup-buffer-mode-map)
                      :states '(normal)
  ...
  (general-define-key :keymaps '(clojure-mode-map cider-repl-mode-map cider-clojure-interaction-mode-map)
                      :states '(normal)
                      "c" (general-key-dispatch 'general-dispatch-evil-change-exchange-sp
