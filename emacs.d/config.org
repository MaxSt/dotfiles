...
#+BEGIN_SRC emacs-lisp
  (use-package general
    ...
    (general-define-key
     ...
     "d" 'kill-this-buffer
     "r" (general-simulate-key ":%s/\C-r//" :state 'normal)
...
#+BEGIN_SRC emacs-lisp
  (defvar org-export-output-directory (concat (getenv "HOME") "/Downloads/org-exports") "directory used for org-mode export")
