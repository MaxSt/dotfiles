...
#+begin_src emacs-lisp
  (use-package challenger-deep-theme
    :straight (:host github :repo "challenger-deep-theme/emacs" :branch "master" :local-repo-name "challenger-deep-theme")
    :ensure t
...
#+BEGIN_SRC emacs-lisp
    (use-package doom-modeline
      ...
      (setq-default mode-line-format 
                    '((:eval (propertize "%-" 'face '(:foreground "#100e23" :background "#1b182c" :height 0.9 :weight normal)))))
      (setq-default header-line-format
                    '((:eval (doom-modeline 'main)))))
#+END_SRC
