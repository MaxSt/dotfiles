...
#+RESULTS:
: [nil 26219 60386 959884 nil elpaca-process-queues nil nil 45999 nil]
...
#+BEGIN_SRC emacs-lisp :tangle init.el
    (use-package proctrack-mode
        :ensure (:host gitlab :repo "pennersr/proctrack-mode"))
#+end_src
...
#+BEGIN_SRC emacs-lisp :tangle init.el
  (use-package org-menu
    :ensure (:host github :repo "sheijk/org-menu" :branch "main")
   )
#+END_SRC
