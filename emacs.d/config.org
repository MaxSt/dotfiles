...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'default-frame-alist '(font . "Monoid-12:spacing=100"))
#+END_SRC
** disable menubar
#+BEGIN_SRC emacs-lisp
  (scroll-bar-mode 0)
...
#+BEGIN_SRC emacs-lisp
  ...
  (general-def '(operator normal visual) :prefix my-leader2
...
#+begin_src emacs-lisp
  ...
  (evil-define-operator evil-decide-delete-fun (beg end)
    "decide which change function to use"
    (if (seq-contains lisp-modes major-mode)
        (evil-sp-delete beg end)
      (evil-delete beg end)))
  ...
  (general-def 'normal
    "d" (general-key-dispatch 'evil-decide-delete-fun
          :name general-dispatch-evil-delete-exchange
...
#+BEGIN_SRC emacs-lisp
  (use-package worf
    ...
    (add-hook 'worf-mode-hook
              (lambda ()
                (push `(worf-mode . ,(newmap (make-sparse-keymap))) minor-mode-overriding-map-alist)))
