    ...
    (custom-theme-set-faces
     ...
     `(flatcolor-linum
       ((((type graphic)) :inherit linum :background ,bg)
        (t                :inherit linum)))
     `(flatcolor-minibuffer-active ((,c (:background ,bg))))
     `(flatcolor-nlinum-highlight  ((,c (:foreground ,linum-hl-fg :bold nil))))
     `(flatcolor-flycheck-error    ((,c (:underline nil :foreground ,black :background ,red))))
     `(flatcolor-flycheck-warning  ((,c (:underline nil :foreground ,black :background ,yellow))))
     `(flatcolor-flycheck-info     ((,c (:underline nil :foreground ,black :background ,green))))
     ;; Base
     ...
     `(flatcolor-modeline-buffer-path       ((,c (:foreground ,(if bold white cyan) :bold ,bold))))
     `(flatcolor-modeline-buffer-project    ((,c (:foreground ,fg))))
     `(flatcolor-modeline-buffer-modified   ((,c (:foreground ,red))))
     `(flatcolor-modeline-buffer-major-mode ((,c (:foreground ,(if bold white blue) :bold ,bold))))
     `(flatcolor-modeline-highlight     ((,c (:foreground ,blue))))
     `(flatcolor-modeline-panel         ((,c (:foreground ,black :background ,blue))))
     `(flatcolor-modeline-bar           ((,c (:background ,blue))))
     `(flatcolor-modeline-eldoc-bar     ((,c (:background ,yellow))))
     ...
     `(ivy-minibuffer-match-face-1 ((,c (:background ,cyan :foreground ,black))))
     `(ivy-minibuffer-match-face-2 ((,c (:background ,magenta :foreground ,black :bold ,bold))))
     `(ivy-minibuffer-match-face-3 ((,c (:background ,green :foreground ,black   :bold ,bold))))
     `(ivy-minibuffer-match-face-4 ((,c (:background ,yellow :foreground ,black  :bold ,bold))))
     ...
     `(org-block-begin-line      ((,c (:background ,current-line :foreground ,magenta))))
     `(org-block-end-line        ((,c (:inherit org-block-begin-line))))
     `(org-block-background      ((,c nil)))
